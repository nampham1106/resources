...
topics = [ 'healthy-living', 'cancer', 'international-health-services', 'sexual-education', 'consultation', 'beauty-wellness', 'proactive-health']
topics_sentences = {}
for topic in topics:
    ...
    def validate_file(file):
        ...
        try:
            ...
            if doc_id != basename(file)[:-4]:
                warn(file, 1, "File name should be the same as doc_id", "E102")
